...
<div class="card bg-warning">
  <div class="card-body">
		...
		Falling Scale : <span class="badge rounded-pill bg-dark">${fallingScale}</span>
...
<div class="tab-content" id="myTabContent">
  ...
  <div class="tab-pane fade" id="tradesList" role="tabpanel" aria-labelledby="contact-tab"><tags:tradeListShorting/></div>
</div>

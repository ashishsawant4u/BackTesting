  ...
  <tbody class="searchable">
	<c:forEach var="trade" items="${tradeList}">
		...
		<c:if test="${trade.tradeEntry.tradeStatus eq 'STOP LOSS'}">
			...
			<td><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${trade.tradeEntry.shortEntryPrice}" /></td>
			<td><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${trade.tradeEntry.stopLossPrice}" /></td>
			<td><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${trade.tradeEntry.shortTargetPrice}" /></td>
